            ...
            <div class="right">
              <div class="card bg-transparent border-0">
                <form method="POST" action="controller/controller.php" class="m-auto">
                  <h1 class="title_signin mt-4 mb-4">Send Email</h1>
                  <label>Enter your email to send verify</label>
                  <br><br>
                  ...
                  <div class="form-group">
                    <div class="form-control p-0 border-0">
                      <input type="submit" name="sendemail" class="rounded rounded-0 signin btn-lg text-white w-100 border-0" value="Send Email" style="outline: none;background-color: #6d4c41;" onclick="lsRememberMe()">
                    </div>
                  </div>
